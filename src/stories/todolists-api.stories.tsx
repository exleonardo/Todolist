...
export const DeleteTodolist = () => {
    const [state, setState] = useState<any>(null)
    useEffect(() => {
        todolistsApi.deleteTodolist("75cbbbae-39ee-4ba8-ab46-15d421cd18e2").then((res)=>setState(res.data))
    }, [])
...
export const UpdateTodolistTitle = () => {
    const [state, setState] = useState<any>(null)
    useEffect(() => {
        todolistsApi.updateTodolistTitle("7dd32807-e50a-4247-93e7-64b2d534f959","LOL").then((res)=>setState(res.data))
    }, [])
...
export const CreateTasks = () => {
    const [state, setState] = useState<any>(null)
    useEffect(() => {
        todolistsApi.createTask("7dd32807-e50a-4247-93e7-64b2d534f959","REACT!!").then((res)=>setState(res.data))
    }, [])
...
export const UpdateTask = ()=>{
    ...
    const updateTask = ()=>{
todolistsApi.updateTask(todolistId,taskId,{title:newTitle,completed:false,deadline:null,startDate:null,description:"Update task",priority:1,status:1}).then((res)=>setState(res))
    }
